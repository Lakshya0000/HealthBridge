...
import com.healthbridge.user.payloads.ApiResponse;
...
public class UserController {
 ...
 @Autowired
 private com.healthbridge.user.services.UserService userService;
 
 @Autowired
 private com.healthbridge.user.repositories.UserRepo userRepo;
